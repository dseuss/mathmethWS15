...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Flächenberechnung \& Volumenberechnung}
...
\begin{subex}
  ...
  \item Berechnen Sie das Volumen des Körpers $K = \{(x,y,z) \in \mathbb{R}^3 \, \vert \, x \in [-1, 1], x^2 + y^2 \le 1, 0 \le z \le 1 - \vert x \vert\}$ gegeben durch
  \[
    V 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Substitution in Mehrfachintegralen}
...
\begin{subex}
  \item Was bedeuten diese beiden Gleichung geometrisch?
  ...
  \item Nutzen Sie das Ergebnis aus a) um das Volumen des Körpers $K$ aus Aufgabe~\ref{sec:flaechenberechnung} zu berechnen.
  Achten Sie insbesondere auf die neuen Integrationsgrenzen.
  \item Benutzen Sie Polarkoordinaten um den Flächeninhalt der Menge
  \[
