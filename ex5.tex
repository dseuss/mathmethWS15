...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Ableitungen elementarer Funktionen \points{7}}
...
\begin{subex}
  ...
  \item\points{2} $\left( x^n \right)' = n \, x^{n-1}$ für $n \in \NN$ (Hinweis: Binomischer Lehrsatz)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Partielle Ableitung als lineare Approximation \points{5}}
